...
$result = $appointment->appointmentResultPenalty();
...
$html = "
    ...
    <body>
        <div class=\"row\">
            ...
            <p class=\"header\">Penalty Report</p>
            <p>Librarian: " . $_SESSION['fullname_admin'] . "</p>
            <p>Date of report: " . date("Y/m/d") . "<br></p>
        </div>";

// Fetch the total number of borrowed books
$borrowTtotal = $appointment->CountAppointmentResultPenalty();
$html .= "<p>Total Penalty: " . $borrowTtotal['AppointmentTotal'] . "</p>";
