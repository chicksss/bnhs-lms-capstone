    ...
    <main class="home-section">
        ...
        <section style="margin-left:2%">
            ...
            <div class="container" style="background-color:white">
                <h5>Insert user borrower</h5>
                <div class="form-group">


                    <form action="admin_user_list_borrowed.php" method="POST">
                        <?php if($resulUser) { ?>
                        <input type="hidden" name="appointment_Id" value="<?php echo $appointment_Id; ?>">
                        <div class="row">
                            <div class="col">
                                <label for=""> Account ID</label>
                                <input type="number" class="form-control" value="<?php echo $resulUser['user_id'] ?>"
                                    placeholder="Account_ID" name="borrow_user_id" id="">
                            </div>
                            <div class="col">
                                <label for=""> Borrower Name</label>
                                <input type="text" class="form-control"
                                    value="<?php echo $resulUser['borrower_name'] ?>" placeholder="Borrower Name"
                                    name="borrow_name" id="">
                            </div>
                            <div class="col">
                                <label for=""> Borrower Book</label>
                                <input type="text" class="form-control" value="<?php echo $resulUser['book_title'] ?>"
                                    placeholder="Borrower Book" name="borrow_book_title" id="">
                            </div>
                            <?php } ?>
                            <div class="col">
                                <label for=""> Date Return</label>
                                <input type="date" class="form-control" name="borrow_date" id="">
                            </div>
                        </div>
                        <br>
                ...
                <!-- <div class="container" style="text-align:right">
                    <button type="submit" name="create" class="btn btn-primary"><a href="admin_user_accounts.php"
                            style="color:white; text-decoration:none">Go to user
                            accounts</a></button>
                </div> -->
