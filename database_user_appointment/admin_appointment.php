...
<body>
    ...
    <div class="ml-52 p-2">
        <div class="absolute mt-[-110px]">
            <h1 class="text-2xl font-bold px-3">HOLD</h1>
        </div>

        <div class="absolute mt-[-50px] ml-[700px] px-10">
...
$bookResult = $appointment->appointmentResult(); 
            ...
            <table class="w-full">
                ...
                <tbody class="text-xs">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-2 w-[150px]">
                            <p class="font-light"><?php echo htmlspecialchars($t['title']); ?></p>
                            </td>
                        <td class="px-6 py-2">
                ...
                if ($t['status'] == 'Available' || $t['status'] == 'Borrowed') {
                    if ($appointDate >= $currentDate) {
                        ...
                        if ($t['status'] == 'Available') {
                            echo '<span style="color:gray; font-style: italic">Expired</span>';
                ...
                ?>
                        ...
                        <td class="px-6 py-2">
                             ...
                             $currentDate = date('Y-m-d');
                                ...
                                if ($t['status'] == 'Available' || $t['status'] == 'Borrowed') {
                                    if ($appointDate >= $currentDate) {
                                        ...
                                        // echo $daysUntilAppoint . " Day(s) Left";
                                        ?>
                            <button type="submit" class="btn" style="background-color: rgba(0, 0, 0, 0);">
                                <a href="admin_borrower_Accept.php?appointment_Id=<?php echo $t['appointment_Id']; ?>">
                            ...
                            <button type="submit" class="btn" style="background-color: rgba(0, 0, 0, 0);" disabled>
                                <a href="admin_borrower_Accept.php?appointment_Id=<?php echo $t['appointment_Id']; ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <td class="px-6 py-2">
                            <button type="submit" class="btn" style="background-color: rgba(0, 0, 0, 0);">
                                <a
                                    href="admin_borrower_Decline.php?appointment_Id=<?php echo $t['appointment_Id']; ?>&book_Id=<?php echo $t['book_Id']; ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-6">
