...
if(isset($_POST['addAuthor'])){
    ...
    header("Location: add_more_authors_after_addingNewBook.php?id=".$b_id);
        }
...
<body class="font-['Quicksand']">
    ...
    <div class="ml-52 p-2">
        ...
        <i class=" flex justify-center">If you are done adding authors you can proceed to <a href="admin_AddCopies_BookAfterAddAuthor.php" class="underline"> "Add copies"</a></i>
        ...
        <div class="flex justify-evenly px-10 gap-2 py-3">
            <div class="card rounded-lg p-0 ">
                ...
                <?php if ($result): ?>
                <form method="POST" action="add_more_authors_after_addingNewBook.php">
                    <br>
                    <input type="hidden" name="b_id" value="<?php echo $result['id']; ?>">
