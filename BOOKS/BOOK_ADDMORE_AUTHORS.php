...
if(isset($_POST['addAuthor'])){
    ...
    header("Location: BOOK_ADDMORE_AUTHORS.php?id=".$b_id);
        }
...
<body class="font-['Quicksand']">
    ...
    <div class="ml-52 p-2">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <div class="col">
                            ...
                            <form action="BOOK_ADDMORE_AUTHORS.php" method="POST">
        ...
        <div class="flex justify-evenly px-10 gap-2 py-3">
            <div class="card rounded-lg p-0 ">
                ...
                <?php if ($result): ?>
                <form method="POST" action="BOOK_ADDMORE_AUTHORS.php">
                    <br>
                    <input type="hidden" name="b_id" value="<?php echo $result['id']; ?>">
 ...
 <i class=" flex justify-center">If you want to add a book copy click -> <a href="admin_AddCopies_BookAfterAddAuthor.php" class="underline"> " Add Copies"</a></i>
